...
export default function VideosPage() {
  ...
  const getVideoThumbnail = (url: string) => {
    ...
    // For Vimeo, we'd need a different approach
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Video Documentation</h1>
          <p className="text-gray-600">Upload and manage video tutorials and documentation</p>
        </div>
          ...
          <div key={video._id} className="bg-white rounded-lg shadow-md overflow-hidden border border-gray-200">
            ...
            <div className="relative aspect-video bg-gray-200">
              <img
                ...
                onError={(e) => {
                  e.currentTarget.src = '/video-placeholder.png';
                }}
              />
